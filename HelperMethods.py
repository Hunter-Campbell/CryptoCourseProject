...
def ecb_cbc_encrypt_and_send(message, server, cipher):
...
def ecb_cbc_decrypt_and_display(cipher_text, cipher, *optional_decryption_cipher):
...
def cbc_encrypt_and_send(message, server, cipher):
